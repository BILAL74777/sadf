                    ...
                    <form  class="php-email-form">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">{{translate('Your Name')}}</label>
                                <input
                                    type="text"
                                    class="form-control"
                        ...
                        <div class="form-group">
                            <label for="email">{{translate('Subject')}}</label>
                            <input
                                type="text"
                                class="form-control"
                                id="subject"
                        ...
                        <div class="my-3" v-if="message_loading != 0">
                            <div class="loading"></div>
                        </div>
                        <div class="text-center" v-if="message_loading == 0">
