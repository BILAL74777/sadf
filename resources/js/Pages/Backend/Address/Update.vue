<template>
    <main id="main" class="main">
        <div class="pagetitle d-flex justify-content-between">
            <div>
                <h1>{{ translate("Update Address") }}</h1>
                <nav>
                    <ol class="breadcrumb">
...
export default {
    ...
    methods: {
        ...
        fetchAddressRecord() {
            axios
                .get(route("api.address.show", this.addressId), {
                    headers: {
                        Authorization: "Bearer " + this.$page.props.auth_token,
                    },
                })
        ...
        submit() {
            ...
            axios
                .post(route("api.address.update"), formData, {
                    headers: {
                        Authorization: "Bearer " + this.$page.props.auth_token,
                    },
                })
