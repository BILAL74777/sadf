<template>
    <main id="main" class="main">
        ...
        <div class="mb-3 d-flex justify-content-end">
            <Link class="btn btn-success" :href="route('languages.add')"><i class="bi bi-plus-lg"></i> {{ translate('Add New Language') }} </Link>
        </div>
        <!-- End Page Title -->
                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-center">{{ translate('Options') }} </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <Link
                                            ...
                                            title="Translations"
                                            :href="route('translations.show', language.id)"
                                        >
...
import DefaultLanguage from "@/Pages/Backend/Language/DefaultLanguage";
...
export default {
    ...
    methods: {
        ...
        deleteThis(){
            axios.delete(route('api.languages.delete', this.deleteId),{
                headers: {"Authorization" : 'Bearer ' + this.$page.props.auth_token}
            }).then(() => {
