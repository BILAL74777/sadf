...
export default {
    ...
    props: ["events_subscribers"],
    created() {
        // this.fetchRecord();
        console.log(this.events_subscribers);
    },
    data() {
        return {
            dataProperty: "",
    ...
    methods: {
        submit() { 
            ...
            // console.log(JSON.stringify(this.form.time));
            formData.append("subject", this.form.subject); 
            formData.append("day", this.form.day); 
            formData.append("time", JSON.stringify(this.form.time)); 
            axios
                .post(route("api.emails.send.to.subscribers"),formData, {
                    headers: {
                        Authorization: "Bearer " + this.$page.props.auth_token,
                    },
                })
                .then((response) => {
                    toastr.success(this.translate("Stored successfully."));
                    this.formStatus = 1;
