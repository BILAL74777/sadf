<template>
    <main id="main" class="main">
        <div class="pagetitle d-flex justify-content-between">
            <div>
                <h1>{{ translate("Update Company") }}</h1>
                <nav>
                    <ol class="breadcrumb">
...
export default {
    ...
    methods: {
        ...
        fetchCompanyRecord() {
            axios
                .get(route("api.company.show", this.companyId), {
                    headers: {
                        Authorization: "Bearer " + this.$page.props.auth_token,
                    },
                })
                .then((response) => {
                    ...
                    this.form.rcu = response.data.rcu;
        ...
        submit() {
            ...
            axios
                .post(route("api.company.update"), formData, {
                    headers: {
                        Authorization: "Bearer " + this.$page.props.auth_token,
                    },
                })
