        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="/backend/assets/img/profile-img.jpg" alt="Profile" class="rounded-circle" @error="setAltImg">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{$page.props.user.name}}</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{$page.props.user.email}}</div>
                  </div>
                  ...
                  <form @submit.prevent="UpdateProfile">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="/backend/assets/img/profile-img.jpg" alt="Profile" @error="setAltImg">
                        <div class="pt-2">
                      ...
                      <div class="col-md-8 col-lg-9">
                                ...
                                <div class="form-floating">
                                    <input
                                        ...
                                        :class="{ 'invalid-bg': formProfileErrors.user_name }"
                                ...
                                <div
                                    ...
                                    v-if="formProfileErrors.user_name"
                                >
                                    {{ formProfileErrors.user_name[0] }}
                                </div>    
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                                <div class="form-floating">
                                    ...
                                    />
                                    <label for="new_password">New Passw </label>
                                </div>
                                <div
                                    class="invalid-feedback animated fadeIn"
...
export default {
    ...
    methods: {
      ChangePassword(){
            ...
            axios.post(route('api.admin.password.update'),this.form,
            {
                 headers: {
                    "Authorization" : 'Bearer ' + this.$page.props.auth_token,
                }
            }).then((data) => {
                this.$inertia.get(route("admin.login"));
                toastr.success("Password Changed Successfully.");
                this.$inertia.get(route('admin.profile'));
            }).catch(error => {
       ...
       currentUser(){
      //       axios.get(route('api.admin.user.show', this.userId),{
      ...
      //  UpdateProfile() {
      //       axios.post(route('api.admin.profile.update'),this.formProfile,
      //       {
      //           headers: {
      //               "Authorization" : 'Bearer ' + this.$page.props.auth_token,
      //           }
