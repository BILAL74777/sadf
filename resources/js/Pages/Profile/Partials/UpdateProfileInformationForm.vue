    ...
    <template #form>
      ...
      <div class="mb-3" v-if="$page.props.jetstream.managesProfilePhotos">
        ...
        <div class="mt-2" v-show="! photoPreview">
          <img :src="user.profile_photo_url" alt="Current Profile Photo" class="rounded-circle" @error="setAltImg">
        </div>

        <!-- New Profile Photo Preview -->
        <div class="mt-2" v-show="photoPreview">
          <img :src="photoPreview" class="rounded-circle" width="80px" height="80px" @error="setAltImg">
        </div>
